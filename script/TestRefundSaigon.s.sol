...
/**
 * @title TestRefundSaigon
 * @notice Script para probar la funcionalidad de refund on-chain en Ronin Testnet (Saigon)
 * @dev Este script:
 ...
 */
contract TestRefundSaigon is Script {
    UnoLobbyV2 public unoLobby;
    
    // Entry fee para el test (0.001 RON = 1000000000000000 wei)
    ...
    function run() external {
        ...
        console.log("https://saigon-app.roninchain.com/address/", address(unoLobby));
        console.log("\nSave this address to .env:");
        console.log("CONTRACT_ADDRESS_SAIGON=", address(unoLobby));
    }
}
