...
io.on('connection', (socket) => {
    ...
    socket.on('createLobby', ({ username, lobbyName, isPrivate, password }) => {
        ...
        lobbies[lobbyId] = {
            ...
            hasDrawnCard: {} // Controla si el jugador ya robó carta este turno
        };
    ...
    socket.on('drawCard', ({ lobbyId }) => {
        ...
        if (lobby.hasDrawnCard[socket.id]) {
            return socket.emit('lobbyError', 'Solo puedes robar una carta por turno. Debes jugarla si puedes, o pasar.');
}
